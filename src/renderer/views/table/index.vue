<template>
  <div class="app-container">
    <div class="button-group">
      <el-link type="success" @click="connectAll">测试连接性</el-link>
    ...
    <el-table v-loading="loading" :data="tableData" border :height="`calc(100vh - 130px)`">
      ...
      <el-table-column prop="ip" label="服务器ip" width="180"> </el-table-column>
      <el-table-column prop="user" label="服务器用户" width="180"> </el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      async onChange(file) {
        ...
        if (uploadFilesArr.length == 0) {} else {
